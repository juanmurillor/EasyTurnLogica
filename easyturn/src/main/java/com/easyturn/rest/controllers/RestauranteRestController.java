...
public class RestauranteRestController {
	...
	public void saveRestaurante(@RequestBody RestauranteDTO restauranteDTO) throws Exception {
		try {
	...
	public void deleteRestaurante(@PathVariable("idrestaurante") Integer idrestaurante) throws Exception {
		try {
	...
	public void updateRestaurante(@RequestBody RestauranteDTO restauranteDTO) throws Exception {
		try {
			Restaurante restaurante = restauranteMapper.restauranteDTOToRestaurante(restauranteDTO);
	...
	public RestauranteDTO getRestaurante(@PathVariable("idrestaurante") Integer idrestaurante) throws Exception {
		try {
			Restaurante restaurante = businessDelegatorView.getRestaurante(idrestaurante);
	...
	@GetMapping(value = "/getRestauranteByUsuario")
	public List<RestauranteDTO> getRestauranteByUsuario(@RequestParam("email") String email) throws Exception {
		try {
			List<Restaurante> restauranteUsuario = businessDelegatorView.findRestauranteByUsuario(email);
			
			return restauranteMapper.listRestauranteToListRestauranteDTO(restauranteUsuario);
		} catch (Exception e) {
			log.error(e.getMessage(),e);
		}
		return null;
