    ...
    */
    ...
    public void saveUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            ...
            if (getUsuarios(entity.getEmail()) != null) {
    ...
    public void deleteUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            administrativoses = administrativosDAO.findByProperty("usuarios.email",
                    entity.getEmail());
            ...
            restaurantes = restauranteDAO.findByProperty("usuarios.email",
                    entity.getEmail());

            if (Utilities.validationsList(restaurantes) == true) {
                throw new ZMessManager().new DeletingException("restaurantes");
            }

            usuariosDAO.deleteById(entity.getEmail());
    ...
    public Usuarios getUsuarios(String email) throws Exception {
        ...
        try {
            entity = usuariosDAO.findById(email);
        } catch (Exception e) {
