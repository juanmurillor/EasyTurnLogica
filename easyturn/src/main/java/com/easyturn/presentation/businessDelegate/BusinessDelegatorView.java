...
public class BusinessDelegatorView implements IBusinessDelegatorView {
    ...
    public List<Tipousuadmin> findByCriteriaInTipousuadmin(Object[] variables,
        Object[] variablesBetween, Object[] variablesBetweenDates)
        throws Exception {
        return tipousuadminLogic.findByCriteria(variables, variablesBetween,
            variablesBetweenDates);
    }
    ...
    public List<Tipousuadmin> findPageTipousuadmin(String sortColumnName,
        boolean sortAscending, int startRow, int maxResults)
        throws Exception {
        return tipousuadminLogic.findPageTipousuadmin(sortColumnName,
    ...
    public List<Productrestaurantes> findByCriteriaInProductrestaurantes(
        ...
        return productrestaurantesLogic.findByCriteria(variables,
    ...
    public List<Productrestaurantes> findPageProductrestaurantes(
        ...
        return productrestaurantesLogic.findPageProductrestaurantes(sortColumnName,
            sortAscending, startRow, maxResults);
    }
    ...
    public List<Restaurante> findByCriteriaInRestaurante(Object[] variables,
        Object[] variablesBetween, Object[] variablesBetweenDates)
        throws Exception {
        return restauranteLogic.findByCriteria(variables, variablesBetween,
            variablesBetweenDates);
    }
    ...
    public List<Restaurante> findPageRestaurante(String sortColumnName,
        boolean sortAscending, int startRow, int maxResults)
        throws Exception {
        return restauranteLogic.findPageRestaurante(sortColumnName,
            sortAscending, startRow, maxResults);
    }
    ...
    public List<Administrativos> findByCriteriaInAdministrativos(
        Object[] variables, Object[] variablesBetween,
        Object[] variablesBetweenDates) throws Exception {
        return administrativosLogic.findByCriteria(variables, variablesBetween,
            variablesBetweenDates);
    }
    ...
    public List<Administrativos> findPageAdministrativos(
        String sortColumnName, boolean sortAscending, int startRow,
        int maxResults) throws Exception {
        return administrativosLogic.findPageAdministrativos(sortColumnName,
            sortAscending, startRow, maxResults);
    }
